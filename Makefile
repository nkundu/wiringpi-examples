...
SRC	=	blink.c blink8.c blink12.c					\
		...
		lowPower.c							\
		rht03.c piglow.c                                                \
                manchester.c rfread.c rfwrite.c dht22.c
...
dht22: dht22.o
	@echo [link]
	@$(CC) -o $@ dht22.o $(LDFLAGS) $(LDLIBS)	

rfwrite: rfwrite.o manchester.o
	@echo [link]
	@$(CC) -o $@ rfwrite.o manchester.o $(LDFLAGS) $(LDLIBS)

rfread: rfread.o manchester.o
	@echo [link]
	@$(CC) -o $@ rfread.o manchester.o $(LDFLAGS) $(LDLIBS)
